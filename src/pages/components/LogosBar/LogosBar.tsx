...
export const LogosBar = ({ }: Props) => {
    return (
        <div className='flex justify-center bg-gray-900 w-full h-max'>
            <div className='flex justify-center place-items-center border-y-2 border-gray-600'>
                <div className='flex justify-center place-items-center gap-[20px] w-[80%] h-[150px]'>
